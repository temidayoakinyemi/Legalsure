      ...
      <div className="alltestimonial">
        ...
        <div className="alltestimonial1">
          <p className="testimonialp">
            Will is one of the most knowledgeable and <br /> competent people I
            have ever met in the IT field. <br /> The more difficult the IT
        ...
        <div className="alltestimonial1">
          <p className="testimonialp">
            reat results. Enjoyable to work with, and <br /> most importantly,
            enabled us to have the <br /> presence on the web we needed to{" "}
            <br /> conduct business in today's market.
          </p>
          <img src={stars} alt="" className="stars" />
          <div className="testimonialdph3h4">
            <img src={dp1} alt="" />
